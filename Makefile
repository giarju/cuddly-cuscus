...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1574852770.91
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1574852770.91
...
ASM_FLAGS += -I../millis
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/a/a8235f9da847120aacc321b8387530f1/Nucleo_blink_led/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
